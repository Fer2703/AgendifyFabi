...
function App() {
  ...
  return (
    <div className="select-none">
      ...
      >
        <div className="w-60 h-10 left-33 top-5 absolute justify-start text-green-900 text-4xl font-bold">Para hoy...</div>
      ...
      <div className="w-80 h-16 left-1/2 transform -translate-x-1/2 top-66 absolute">
        <motion.div 
          className="w-24 h-8 left-1/2 transform -translate-x-1/2 top-0 absolute text-center justify-start text-green-900 text-4xl font-bold font-['League_Spartan']"
        ...
        <motion.div 
          className="w-52 h-8 left-1/2 transform -translate-x-1/2 top-8 absolute text-center justify-start text-green-900 text-7xl font-bold font-['League_Spartan']"
      ...
      <div className='w-full h-[calc(100vh-27rem)] top-108 absolute overflow-y-auto scrollbar-hide'>
        <div className="w-[93%] left-1/2 transform -translate-x-1/2 absolute">
          ...
          return (
            <div key={day}>
              <motion.div 
                className={`w-full h-28 ${tareasDelDia.length > 0 ? 'bg-green-600' : 'bg-white'} rounded-3xl overflow-hidden flex items-center cursor-pointer`}
                whileTap={{ scale: 0.95 }}
                whileHover={{ scale: 1.02 }}
